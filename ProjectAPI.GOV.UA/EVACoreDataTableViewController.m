...
{
    static NSString* identifier = @"EVAFavoritesCell";
    
    EVAFavoritesCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    
    if (!cell) {
        cell = [[EVAFavoritesCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:identifier];
    }
